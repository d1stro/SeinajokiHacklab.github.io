 ...
 * Localized 2016, Tero Korpela
 * 
 * Original source: https://github.com/MilanKacurak/FormatGoogleCalendar/blob/master/format-google-calendar.js
 */
var formatGoogleCalendar = (function() {
    ...
    var formatDateDifferentDay = function(dateStart, dateEnd, dayNames) {
      ...
      if (dayNames) {
        ...
        //month day-day, year
        return dayNameStart + ' ' + dateStart[0] + '-' + dateEnd[0] + '.' + getMonthName(dateStart[1]) + '.' + dateStart[2];
    };
